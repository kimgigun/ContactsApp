    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        findViewById(R.id.btGo).setOnClickListener(new View.OnClickListener(){
            ...
            public void onClick(View v) {
                Toast.makeText(MemberupdateActivity.this, "go to main", Toast.LENGTH_SHORT).show();
                startActivity(new Intent(MemberupdateActivity.this, MemberdetailActivity.class));
            }
        });
    }
}
